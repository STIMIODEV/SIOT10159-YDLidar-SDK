...
function(install_package)
  ...
  if(NOT EXPORT_${PROJECT_NAME})
    ...
    if( PACKAGE_LIB_NAME )
      # Use modern CMake patterns instead of deprecated LOCATION property
    ...
    # install library itself using modern CMake patterns
    if( PACKAGE_LIB_NAME )
    ...
    # Use modern install(EXPORT) instead of deprecated export() + install(FILES)
    if( PACKAGE_LIB_NAME )
  ...
  # Install config files (common for both install and export modes)
  install(FILES
